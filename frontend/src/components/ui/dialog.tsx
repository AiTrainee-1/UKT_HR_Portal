...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Apple-style frosted glass: translucent blurred panel, generous radius,
        // hairline border and layered soft shadows.
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 p-6 duration-300 ease-out",
        "rounded-2xl sm:rounded-3xl border border-white/60 bg-white/75 backdrop-blur-2xl backdrop-saturate-150",
        "shadow-[0_24px_80px_-16px_rgba(15,40,80,0.35),0_2px_8px_rgba(15,40,80,0.08),inset_0_1px_0_rgba(255,255,255,0.8)]",
