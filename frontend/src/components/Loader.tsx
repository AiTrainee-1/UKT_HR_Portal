    ...
    <div className="flex items-center justify-center min-h-[200px]">
      <style>{`
        ...
        .loader {
          --main-size: 8em;
          --text-color: #7ee8ff;
          --shine-color: #00cfff80;
          --shadow-color: #003d5580;
          display: flex;
          justify-content: center;
          align-items: center;
          overflow: hidden;
          ...
          width: 9em;
          height: 1em;
          filter: drop-shadow(0 0 6px #00cfff88) drop-shadow(0 0 18px #00cfff44);
        }
        ...
        .loader .text:nth-child(1) span {
          background: linear-gradient(to right, #7ee8ff 4%, #003d55 7%);
        ...
        .loader .text:nth-child(2) span {
          background: linear-gradient(to right, #7ee8ff 9%, #003d55 13%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(3) span {
          background: linear-gradient(to right, #7ee8ff 15%, #003d55 18%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(4) span {
          background: linear-gradient(to right, #7ee8ff 20%, #003d55 23%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(5) span {
          background: linear-gradient(to right, #00cfff, #7ee8ff, #b0f4ff, #7ee8ff, #00cfff);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(6) span {
          background: linear-gradient(to right, #003d55 29%, #7ee8ff 32%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(7) span {
          background: linear-gradient(to right, #003d55 34%, #7ee8ff 37%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(8) span {
          background: linear-gradient(to right, #003d55 39%, #7ee8ff 42%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .text:nth-child(9) span {
          background: linear-gradient(to right, #003d55 45%, #7ee8ff 48%);
          background-size: 200% auto;
          background-clip: text;
          -webkit-background-clip: text;
          color: transparent;
        ...
        .loader .line::before {
          ...
          height: 100%;
          width: 100%;
          background: linear-gradient(to right, #00cfff, #7ee8ff);
          opacity: 0.3;
        }
        ...
        .loader .line::after {
          ...
          height: 100%;
          width: 100%;
          background: linear-gradient(to right, #00cfff, #b0f4ff, #00cfff);
          border-radius: 0.05em;
      ...
      <div className="loader-wrapper">
        <div className="loader">
          <div className="text"><span>UK Textile</span></div>
          <div className="text"><span>UK Textile</span></div>
          <div className="text"><span>UK Textile</span></div>
          <div className="text"><span>UK Textile</span></div>
          <div className="text"><span>UK Textile</span></div>
